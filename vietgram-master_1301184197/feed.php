    ...
    <main id="feed">
        ...
        <div class="photo">
            <header class="photo__header">
                <img src="images/foto_user/rifkialfian/4.jpg" class="photo__avatar" />
                <div class="photo__user-info">
                    <span class="photo__author"><?php echo $_SESSION['username'];?></span>
                </div>
            </header>
            <center><img class="img-fluid" height="400px" width="400px" src="images/foto_user/rifkialfian/<?php echo "/".$rows[$i][1]; ?>" /></center>
